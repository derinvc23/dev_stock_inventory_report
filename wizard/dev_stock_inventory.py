...
class dev_stock_inventory(models.TransientModel):
    ...
    def export_stock_ledger(self):
        ...
        for warehouse_id in self.warehouse_ids:
            ...
            worksheet[work].write(4, 0, 'Compania', header_style)
            worksheet[work].write(4, 1, 'Almacen', header_style)
            worksheet[work].write(4, 2, 'Ubicacion', header_style)
            worksheet[work].write(4, 3, 'Fecha inicial', header_style)
            worksheet[work].write(4, 4, 'Fecha Final', header_style)
            worksheet[work].write(4, 5, 'Gererado por', header_style)
            worksheet[work].write(4, 6, 'Fecha generado', header_style)
            ...
            tags = ['Inicio', 'Recibido', 'Ventas', 'Interno', 'Ajustes', 'Fin']
            ...
            if not self.is_group_by_category:
                ...
                for line in lines:
                    ...
                    worksheet[work].write_merge(r, r, 0, 2, line.get('default_code'), text_left)
                    c=3
                    worksheet[work].write(r,c,line.get('product'), text_left)
                    c += 1
